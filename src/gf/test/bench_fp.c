...
fp_run(int iterations)
{
    ...
    printf("  GF(p) addition runs in .......................................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / (18 * iterations),
           dt_ns/(18 * 20 * iterations));
    ...
    fp_encode(tmp, &b);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) subtraction runs in ....................................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / (6 * iterations),
           dt_ns/(6 *20 * iterations));
    ...
    fp_encode(tmp, &b);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) division by 3 runs in ..................................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / (6 * iterations),
           dt_ns/(6 *20 * iterations));
    ...
    fp_encode(tmp, &b);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) multiplication runs in .................................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / (6 * iterations),
           dt_ns/(6 *20 * iterations));
    ...
    fp_encode(tmp, &a);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) small multiplication runs in .............................. %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / (6 * iterations),
           dt_ns/(6 *20 * iterations));
    ...
    fp_encode(tmp, &a);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) squaring runs in .......................................... %" PRIu64 " cycles [%.3f ns]\n",
    ...
    fp_encode(tmp, &a);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) inversion runs in ......................................... %" PRIu64 " cycles  [%.3f ns]\n",
           cycle_runs[4] / iterations,
           dt_ns/(20 * iterations));
    ...
    fp_encode(tmp, &c[0]);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) batched inversion runs in ................................. %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / iterations,
           dt_ns/(20 * iterations));
    ...
    fp_encode(tmp, &c[0]);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) projective batched inversion runs in ...................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / iterations,
           dt_ns/(20 * iterations));
    ...
    fp_encode(tmp, &a);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  GF(p) sqrt runs in .............................................. %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / iterations,
           dt_ns/(20 * iterations));
    ...
    fp_encode(tmp, &a);
    qsort(cycle_runs + 10, 10, sizeof cycle_runs[0], cmp_u64);
    printf("  Square checking runs in ......................................... %" PRIu64 " cycles [%.3f ns]\n",
           cycle_runs[4] / iterations,
           dt_ns/(20 * iterations));
#endif
    return OK;
