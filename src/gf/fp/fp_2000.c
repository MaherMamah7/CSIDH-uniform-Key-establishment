...
//Command line : python ../external/modarith/monty.py 64 
...
static int inline flatten(spint *n) {
	spint carry=prop(n);
	n[0]-=(spint)1u&carry;
	n[33]+=((spint)0x1400000000u)&carry;
	(void)prop(n);
	return (int)(carry&1);
}
...
static void modadd(const spint *a,const spint *b,spint *n) {
	...
	n[33]=a[33]+b[33];
	n[0]+=(spint)2u;
	n[33]-=(spint)0x2800000000u;
	carry=prop(n);
	n[0]-=(spint)2u&carry;
	n[33]+=((spint)0x2800000000u)&carry;
	(void)prop(n);
}
...
// maximum possible = 45193751955722343038309104821649539106
// Modular multiplication, c=a*b mod 2p
static void modmul(const spint *a,const spint *b,spint *c) {
	dpint t=0;
	spint p33=0x1400000000u;
...
static void nres(const spint *m,spint *n) {
	const spint c[34]={0xccd70a3d70a3d70u,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccccccccu,0xcccccccccu};
	modmul(m,c,n);
}
...
static void modmli(const spint *a,int b,spint *c) {
	...
	spint mask=((spint)1<<60u)-(spint)1;
	udpint t=0;
	spint q,h,r=0x1999999999999999;
...
const digit_t ONE[NWORDS_FIELD] = {0xcccccc, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000000000};
static const digit_t TWO_INV[NWORDS_FIELD] = {0x666666, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800000000};

static const digit_t THREE_INV[NWORDS_FIELD] = {0xaaaaaaaaaeeeeee, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0xaaaaaaaaaaaaaaa, 0x12aaaaaaaa};
