...
//Command line : python ../external/modarith/monty.py 64 
...
static void modmul(const spint *a,const spint *b,spint *c) {
	...
	t+=(dpint)a[0]*b[16]; t+=(dpint)a[1]*b[15]; t+=(dpint)a[2]*b[14]; t+=(dpint)a[3]*b[13]; t+=(dpint)a[4]*b[12]; t+=(dpint)a[5]*b[11]; t+=(dpint)a[6]*b[10]; t+=(dpint)a[7]*b[9]; t+=(dpint)a[8]*b[8]; t+=(dpint)a[9]*b[7]; t+=(dpint)a[10]*b[6]; t+=(dpint)a[11]*b[5]; t+=(dpint)a[12]*b[4]; t+=(dpint)a[13]*b[3]; t+=(dpint)a[14]*b[2]; t+=(dpint)a[15]*b[1]; t+=(dpint)a[16]*b[0]; t+=(dpint)v0*(dpint)p16;  spint v16=((spint)t & mask);  t>>=60;
	t+=(dpint)a[1]*b[16]; t+=(dpint)a[2]*b[15]; t+=(dpint)a[3]*b[14]; t+=(dpint)a[4]*b[13]; t+=(dpint)a[5]*b[12]; t+=(dpint)a[6]*b[11]; t+=(dpint)a[7]*b[10]; t+=(dpint)a[8]*b[9]; t+=(dpint)a[9]*b[8]; t+=(dpint)a[10]*b[7]; t+=(dpint)a[11]*b[6]; t+=(dpint)a[12]*b[5]; t+=(dpint)a[13]*b[4]; t+=(dpint)a[14]*b[3]; t+=(dpint)a[15]*b[2]; t+=(dpint)a[16]*b[1]; t+=(dpint)v1*(dpint)p16;  c[0]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[2]*b[16]; t+=(dpint)a[3]*b[15]; t+=(dpint)a[4]*b[14]; t+=(dpint)a[5]*b[13]; t+=(dpint)a[6]*b[12]; t+=(dpint)a[7]*b[11]; t+=(dpint)a[8]*b[10]; t+=(dpint)a[9]*b[9]; t+=(dpint)a[10]*b[8]; t+=(dpint)a[11]*b[7]; t+=(dpint)a[12]*b[6]; t+=(dpint)a[13]*b[5]; t+=(dpint)a[14]*b[4]; t+=(dpint)a[15]*b[3]; t+=(dpint)a[16]*b[2]; t+=(dpint)v2*(dpint)p16;  c[1]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[3]*b[16]; t+=(dpint)a[4]*b[15]; t+=(dpint)a[5]*b[14]; t+=(dpint)a[6]*b[13]; t+=(dpint)a[7]*b[12]; t+=(dpint)a[8]*b[11]; t+=(dpint)a[9]*b[10]; t+=(dpint)a[10]*b[9]; t+=(dpint)a[11]*b[8]; t+=(dpint)a[12]*b[7]; t+=(dpint)a[13]*b[6]; t+=(dpint)a[14]*b[5]; t+=(dpint)a[15]*b[4]; t+=(dpint)a[16]*b[3]; t+=(dpint)v3*(dpint)p16;  c[2]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[4]*b[16]; t+=(dpint)a[5]*b[15]; t+=(dpint)a[6]*b[14]; t+=(dpint)a[7]*b[13]; t+=(dpint)a[8]*b[12]; t+=(dpint)a[9]*b[11]; t+=(dpint)a[10]*b[10]; t+=(dpint)a[11]*b[9]; t+=(dpint)a[12]*b[8]; t+=(dpint)a[13]*b[7]; t+=(dpint)a[14]*b[6]; t+=(dpint)a[15]*b[5]; t+=(dpint)a[16]*b[4]; t+=(dpint)v4*(dpint)p16;  c[3]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[5]*b[16]; t+=(dpint)a[6]*b[15]; t+=(dpint)a[7]*b[14]; t+=(dpint)a[8]*b[13]; t+=(dpint)a[9]*b[12]; t+=(dpint)a[10]*b[11]; t+=(dpint)a[11]*b[10]; t+=(dpint)a[12]*b[9]; t+=(dpint)a[13]*b[8]; t+=(dpint)a[14]*b[7]; t+=(dpint)a[15]*b[6]; t+=(dpint)a[16]*b[5]; t+=(dpint)v5*(dpint)p16;  c[4]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[6]*b[16]; t+=(dpint)a[7]*b[15]; t+=(dpint)a[8]*b[14]; t+=(dpint)a[9]*b[13]; t+=(dpint)a[10]*b[12]; t+=(dpint)a[11]*b[11]; t+=(dpint)a[12]*b[10]; t+=(dpint)a[13]*b[9]; t+=(dpint)a[14]*b[8]; t+=(dpint)a[15]*b[7]; t+=(dpint)a[16]*b[6]; t+=(dpint)v6*(dpint)p16;  c[5]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[7]*b[16]; t+=(dpint)a[8]*b[15]; t+=(dpint)a[9]*b[14]; t+=(dpint)a[10]*b[13]; t+=(dpint)a[11]*b[12]; t+=(dpint)a[12]*b[11]; t+=(dpint)a[13]*b[10]; t+=(dpint)a[14]*b[9]; t+=(dpint)a[15]*b[8]; t+=(dpint)a[16]*b[7]; t+=(dpint)v7*(dpint)p16;  c[6]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[8]*b[16]; t+=(dpint)a[9]*b[15]; t+=(dpint)a[10]*b[14]; t+=(dpint)a[11]*b[13]; t+=(dpint)a[12]*b[12]; t+=(dpint)a[13]*b[11]; t+=(dpint)a[14]*b[10]; t+=(dpint)a[15]*b[9]; t+=(dpint)a[16]*b[8]; t+=(dpint)v8*(dpint)p16;  c[7]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[9]*b[16]; t+=(dpint)a[10]*b[15]; t+=(dpint)a[11]*b[14]; t+=(dpint)a[12]*b[13]; t+=(dpint)a[13]*b[12]; t+=(dpint)a[14]*b[11]; t+=(dpint)a[15]*b[10]; t+=(dpint)a[16]*b[9]; t+=(dpint)v9*(dpint)p16;  c[8]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[10]*b[16]; t+=(dpint)a[11]*b[15]; t+=(dpint)a[12]*b[14]; t+=(dpint)a[13]*b[13]; t+=(dpint)a[14]*b[12]; t+=(dpint)a[15]*b[11]; t+=(dpint)a[16]*b[10]; t+=(dpint)v10*(dpint)p16;  c[9]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[11]*b[16]; t+=(dpint)a[12]*b[15]; t+=(dpint)a[13]*b[14]; t+=(dpint)a[14]*b[13]; t+=(dpint)a[15]*b[12]; t+=(dpint)a[16]*b[11]; t+=(dpint)v11*(dpint)p16;  c[10]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[12]*b[16]; t+=(dpint)a[13]*b[15]; t+=(dpint)a[14]*b[14]; t+=(dpint)a[15]*b[13]; t+=(dpint)a[16]*b[12]; t+=(dpint)v12*(dpint)p16;  c[11]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[13]*b[16]; t+=(dpint)a[14]*b[15]; t+=(dpint)a[15]*b[14]; t+=(dpint)a[16]*b[13]; t+=(dpint)v13*(dpint)p16;  c[12]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[14]*b[16]; t+=(dpint)a[15]*b[15]; t+=(dpint)a[16]*b[14]; t+=(dpint)v14*(dpint)p16;  c[13]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[15]*b[16]; t+=(dpint)a[16]*b[15]; t+=(dpint)v15*(dpint)p16;  c[14]=((spint)t & mask);  t>>=60;
	t+=(dpint)a[16]*b[16]; t+=(dpint)v16*(dpint)p16;  c[15]=((spint)t & mask);  t>>=60;
	c[16] = (spint)t;
}
...
static void modsqr(const spint *a,spint *c) {
	...
	tot=(udpint)a[0]*a[16]; tot+=(udpint)a[1]*a[15]; tot+=(udpint)a[2]*a[14]; tot+=(udpint)a[3]*a[13]; tot+=(udpint)a[4]*a[12]; tot+=(udpint)a[5]*a[11]; tot+=(udpint)a[6]*a[10]; tot+=(udpint)a[7]*a[9]; tot*=2; tot+=(udpint)a[8]*a[8]; t+=tot;  t+=(udpint)v0*p16;  spint v16=((spint)t & mask); t>>=60;
	tot=(udpint)a[1]*a[16]; tot+=(udpint)a[2]*a[15]; tot+=(udpint)a[3]*a[14]; tot+=(udpint)a[4]*a[13]; tot+=(udpint)a[5]*a[12]; tot+=(udpint)a[6]*a[11]; tot+=(udpint)a[7]*a[10]; tot+=(udpint)a[8]*a[9]; tot*=2; t+=tot;  t+=(udpint)v1*p16;  c[0]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[2]*a[16]; tot+=(udpint)a[3]*a[15]; tot+=(udpint)a[4]*a[14]; tot+=(udpint)a[5]*a[13]; tot+=(udpint)a[6]*a[12]; tot+=(udpint)a[7]*a[11]; tot+=(udpint)a[8]*a[10]; tot*=2; tot+=(udpint)a[9]*a[9]; t+=tot;  t+=(udpint)v2*p16;  c[1]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[3]*a[16]; tot+=(udpint)a[4]*a[15]; tot+=(udpint)a[5]*a[14]; tot+=(udpint)a[6]*a[13]; tot+=(udpint)a[7]*a[12]; tot+=(udpint)a[8]*a[11]; tot+=(udpint)a[9]*a[10]; tot*=2; t+=tot;  t+=(udpint)v3*p16;  c[2]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[4]*a[16]; tot+=(udpint)a[5]*a[15]; tot+=(udpint)a[6]*a[14]; tot+=(udpint)a[7]*a[13]; tot+=(udpint)a[8]*a[12]; tot+=(udpint)a[9]*a[11]; tot*=2; tot+=(udpint)a[10]*a[10]; t+=tot;  t+=(udpint)v4*p16;  c[3]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[5]*a[16]; tot+=(udpint)a[6]*a[15]; tot+=(udpint)a[7]*a[14]; tot+=(udpint)a[8]*a[13]; tot+=(udpint)a[9]*a[12]; tot+=(udpint)a[10]*a[11]; tot*=2; t+=tot;  t+=(udpint)v5*p16;  c[4]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[6]*a[16]; tot+=(udpint)a[7]*a[15]; tot+=(udpint)a[8]*a[14]; tot+=(udpint)a[9]*a[13]; tot+=(udpint)a[10]*a[12]; tot*=2; tot+=(udpint)a[11]*a[11]; t+=tot;  t+=(udpint)v6*p16;  c[5]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[7]*a[16]; tot+=(udpint)a[8]*a[15]; tot+=(udpint)a[9]*a[14]; tot+=(udpint)a[10]*a[13]; tot+=(udpint)a[11]*a[12]; tot*=2; t+=tot;  t+=(udpint)v7*p16;  c[6]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[8]*a[16]; tot+=(udpint)a[9]*a[15]; tot+=(udpint)a[10]*a[14]; tot+=(udpint)a[11]*a[13]; tot*=2; tot+=(udpint)a[12]*a[12]; t+=tot;  t+=(udpint)v8*p16;  c[7]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[9]*a[16]; tot+=(udpint)a[10]*a[15]; tot+=(udpint)a[11]*a[14]; tot+=(udpint)a[12]*a[13]; tot*=2; t+=tot;  t+=(udpint)v9*p16;  c[8]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[10]*a[16]; tot+=(udpint)a[11]*a[15]; tot+=(udpint)a[12]*a[14]; tot*=2; tot+=(udpint)a[13]*a[13]; t+=tot;  t+=(udpint)v10*p16;  c[9]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[11]*a[16]; tot+=(udpint)a[12]*a[15]; tot+=(udpint)a[13]*a[14]; tot*=2; t+=tot;  t+=(udpint)v11*p16;  c[10]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[12]*a[16]; tot+=(udpint)a[13]*a[15]; tot*=2; tot+=(udpint)a[14]*a[14]; t+=tot;  t+=(udpint)v12*p16;  c[11]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[13]*a[16]; tot+=(udpint)a[14]*a[15]; tot*=2; t+=tot;  t+=(udpint)v13*p16;  c[12]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[14]*a[16]; tot*=2; tot+=(udpint)a[15]*a[15]; t+=tot;  t+=(udpint)v14*p16;  c[13]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[15]*a[16]; tot*=2; t+=tot;  t+=(udpint)v15*p16;  c[14]=((spint)t & mask);  t>>=60;
	tot=(udpint)a[16]*a[16]; t+=tot;  t+=(udpint)v16*p16;  c[15]=((spint)t & mask);  t>>=60;
	c[16] = (spint)t;
}
...
static void nres(const spint *m,spint *n) {
	const spint c[17]={0x111111112345678u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x111111111111111u,0x911111111111u};
	modmul(m,c,n);
}
...
static void modmli(const spint *a,int b,spint *c) {
	...
	t+=(udpint)a[16]*(udpint)b; c[16]=(spint)t;
